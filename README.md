...
Allows you to play as any survivor within any campaign and swap survivor bots using simple chat commands. Chosen survivors will have their view models, voices, and UI elements to match*, with support for custom models and reskins. Choices remain throughout the current campaign.
